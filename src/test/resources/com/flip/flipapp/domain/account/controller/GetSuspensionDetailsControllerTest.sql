INSERT INTO account ( oauth_id, account_state, recent_login, suspended_at)
VALUES ( 'kakaooauth1', 'ACTIVE', 1, null);

INSERT INTO account ( oauth_id, account_state, recent_login, suspended_at)
VALUES ( 'kakaooauth2', 'SUSPENDED_5_DAYS', 1, '2024-08-30 18:30:15');
