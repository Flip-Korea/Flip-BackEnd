...
public record AddTempPostRequest(
    @NotBlank
    String title,
    @NotNull
    String content,
  ...
  public AddTempPostCommand toCommand(Long profileId) {
    return new AddTempPostCommand(title, content, BgColorType.valueOf(bgColorType),
